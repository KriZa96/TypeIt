...
PerformanceArea::PerformanceArea(ftxui::Component timer_component, ftxui::Component accuracy_component,
                                 ftxui::Component word_calculator_component) :
    timer_component_(std::move(timer_component)), accuracy_component_(std::move(accuracy_component)),
...
ftxui::Component PerformanceArea::get_performance_component() const {
    return ftxui::Renderer([&] {
        return ftxui::dbox(ftxui::flexbox(
                       {ftxui::dbox(ftxui::flexbox({accuracy_component_->Render(), timer_component_->Render(),
