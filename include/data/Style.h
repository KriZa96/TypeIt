//
// Created by Kristijan Zalac on 3/16/25.
//
...
struct Style {
    ...
    inline static const ftxui::Decorator menu_style = ftxui::size(ftxui::WIDTH, ftxui::EQUAL, 20) |
                                                      ftxui::size(ftxui::HEIGHT, ftxui::GREATER_THAN, 20) |
                                                      ftxui::center;

    inline static const ftxui::Decorator performance_component_inside =
            size(ftxui::HEIGHT, ftxui::EQUAL, 3) | size(ftxui::WIDTH, ftxui::EQUAL, 65);


    inline static const ftxui::Decorator performance_component_outside =
            ftxui::border | size(ftxui::HEIGHT, ftxui::EQUAL, 3) | size(ftxui::WIDTH, ftxui::EQUAL, 75);


    inline static const ftxui::Decorator game_session_actions =
            size(ftxui::HEIGHT, ftxui::EQUAL, 3) | size(ftxui::WIDTH, ftxui::EQUAL, 35);
