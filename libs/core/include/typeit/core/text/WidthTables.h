...
// Database, version 17.0.0. Regenerate rather than patch: a hand-edited
...
inline constexpr const char* kUnicodeVersion = "17.0.0";

/// East Asian Wide and Fullwidth, plus Emoji_Presentation: two columns.
inline constexpr std::array<CodePointRange, 123> kWide{{
        {0x1100, 0x115F},
        {0x231A, 0x231B},
        {0x2329, 0x232A},
        {0x23E9, 0x23EC},
...
/// Mn, Me, Cf and Cc: no column of their own.
inline constexpr std::array<CodePointRange, 378> kZeroWidth{{
        {0x0000, 0x001F},
        {0x007F, 0x009F},
        {0x00AD, 0x00AD},
        {0x0300, 0x036F},
