...
// Character Database, version 17.0.0. Regenerate rather than patch: a
...
inline constexpr const char* kNormalizationUnicodeVersion = "17.0.0";

/// Canonical combining classes, coalesced into ranges. Everything
/// absent is class 0, which is most of Unicode.
inline constexpr std::array<CombiningClassRange, 403> kCombiningClasses{{
        {0x0300, 0x0314, 230},
        {0x0315, 0x0315, 232},
        {0x0316, 0x0319, 220},
        {0x031A, 0x031A, 232},
...
inline constexpr std::array<Decomposition, 2081> kCanonicalDecompositions{{
...
inline constexpr std::array<Composition, 961> kCanonicalCompositions{{
...
inline constexpr std::array<CodeRange, 199> kPunctuation{{
        {0x0021, 0x0023},
        {0x0025, 0x002A},
        {0x002C, 0x002F},
        {0x003A, 0x003B},
...
inline constexpr std::array<CaseMapping, 1488> kSimpleLowercase{{
        {0x0041, 0x0061},
        {0x0042, 0x0062},
        {0x0043, 0x0063},
        {0x0044, 0x0064},
